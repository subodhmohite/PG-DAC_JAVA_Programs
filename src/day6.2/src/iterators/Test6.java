...
public class Test6 {
	...
	//	intList.add(12345);//structural modification (size is modified)
	//	intList.remove(0);//structural modification (size is modified)
		intList.set(0, 12345);
		while (itr.hasNext())
			System.out.println(itr.next());//conc modi. exc
