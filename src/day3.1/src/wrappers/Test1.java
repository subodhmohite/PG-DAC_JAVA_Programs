...
public class Test1 {
	...
	public static void main(String[] args) {
		...
		//add float value in to Float:boxing
		Float j=Float.valueOf(77.7f);//Boxing
		float j2=j.floatValue();//Unboxing
		j=2345.567f;//auto boxing
		j++;//auto un boxing-->increment-->auto boxing
